...
public class URLConfig {
    ...
    public final static String BIT_ORDER = BASE_HOST + "bitorder/saveBitOrder.d?productId=xxx&openId=xxx&payWayCode= WEIXIN&payTypeCode=XXX&price=XXX&token=XXX";//充值
    //比特币支付
