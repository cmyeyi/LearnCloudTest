...
public class HttpFileProtocolAdapter<T> extends AbsHttpFileProtocolAdapter<T> {
	private static final String TAG = "HttpFileProtocolAdapter";
	private static final char CHAR_DOT = '.';
	private static final String REPLACE_EXCEPTION = "Expected BEGIN_OBJECT but was BEGIN_ARRAY";
	private Gson gson = new Gson();

	public HttpFileProtocolAdapter(Object request, Class<T> valueType,
	...
	private T stringToBeanRelpace(String str, Class valueType, String eStr) {
		...
		String jSonStr = str.trim().replaceAll(fieldName + ":\\[\\]",
				fieldName + ":\\{\\}");
		T result = null;
		try {
